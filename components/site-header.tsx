    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-background/80 backdrop-blur-xl">
      <div className="relative mx-auto max-w-5xl px-6 py-4">
        <button
          ...
          className="absolute right-6 top-1/2 -translate-y-1/2 text-white lg:hidden"
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <nav className="hidden flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm font-medium text-white lg:flex">
            ...
            <div className="group relative">
              ...
              <div className="invisible absolute left-1/2 top-full -translate-x-1/2 pt-4 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100">
                <div className="flex w-56 flex-col gap-1 rounded-md border border-white/10 bg-surface p-2 text-center shadow-xl shadow-black/40">
            ...
            <Link href="/testimonials" className="transition-colors hover:text-accent">Customer Testimonials</Link>
      ...
      {menuOpen && (
        <nav className="flex flex-col items-center gap-1 border-t border-white/10 px-6 py-6 text-center text-sm text-white lg:hidden">
          ...
          <Link href="/#contact" onClick={() => setMenuOpen(false)} className="mt-3 flex items-center gap-2 rounded-md bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground">
            Request Demo <ArrowRight size={15} />
          </Link>
        </nav>
      )}
